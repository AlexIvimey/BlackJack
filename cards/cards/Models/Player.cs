...
namespace game.Models
{
    public class Players
    {
        ...
        public void CalculateScore()
        {
            ...
            foreach (Card card in Hand.OrderByDescending(c=>c.Number))
            {
                

                if (card.Number == 1 && Score <= 10 && card==Hand.Last())
                    card.Value = 11;
        ...
        //This method will add 100 dollars to the users wallet and allow them to input a bet as long as it is 100 or less
